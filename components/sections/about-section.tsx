          ...
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                Why Choose
                <br />
                <span className="text-foreground/40">Qwickbit</span>
              </h2>
            </div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Deep domain expertise across insurance, healthcare, ecommerce, transportation, real estate, sports, and
                aviation sectors.
              </p>
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Proven track record delivering enterprise-grade AI, IoT, and cloud solutions that drive measurable
                business impact.
              </p>
            </div>
          </div>
