...
const productsSolutionsMenu: ProductsSolutionsMenuItem[] = [
  {
    ...
    items: [
      ...
      { name: "Food Ordering", description: "Manage orders from kitchen to customer in a simple manner.", icon: Utensils },
      ...
      { name: "Recruitment Agency", description: "Manage end to end employee life cycle with a ease.", icon: Briefcase },
      {
