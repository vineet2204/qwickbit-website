...
import { useRef, useEffect, useState, forwardRef, useCallback, useMemo, useImperativeHandle } from "react"
...
export const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>((props, ref) => {
  ...
  return (
    <motion.span className={cn("inline-block", mainClassName)} {...rest} layout transition={transition}>
